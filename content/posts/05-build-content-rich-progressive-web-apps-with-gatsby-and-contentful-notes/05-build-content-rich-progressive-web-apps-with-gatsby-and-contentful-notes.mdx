---
title: Build Content Rich Progressive Web Apps with Gatsby and Contentful Notes
date: 2020-04-22
slug: build-content-rich-apps-gatsby-and-contentful-notes
image: ./images/cover.png
icon: ../icons/gatsby.png
tags: ['gatsby']
lead: These notes are intended to be used and studied in tandem with Khaled Garbaya's Build Content Rich Progressive Web Apps with Gatsby and Contentful course.
video: false
---
...
module.exports = function (migration) {
  ...
  instructor.createField('avatar').name('Avatar').type('Link').linkType('Asset')
...
```
git remote add origin git@github.com: Khaledgarbaya/jamstackposts.git
```
