---
title: Fix Common Git Mistakes Notes
date: 2020-02-29
slug: fix-common-git-mistakes-notes
image: ./images/cover.png
icon: ../icons/git.png
tags: ['git']
lead: These notes are intended to be used and studied in tandem with Chris Achard's course.
---
...
![cover](https://raw.githubusercontent.com/laurosilvacom/fix-common-git-mistakes-notes/master/cover.png)
